...
class CapitalTests(TestCase):
    ...
    def test_capital_createview(self):
        ...
        self.assertEqual(Capitals.objects.last().city, "New Delhi")
        self.assertEqual(Capitals.objects.last().country, "India")

    @classmethod
    def setUpTestData(cls):
        cls.capital = Capitals.objects.create(city="Riga", country="Latvia")
